function [A, rCond] = scalaLuSolve(transposeFirstMatrix, A, B)
...
%   Copyright 2006-2016 The MathWorks, Inc.
    ...
    [localA, rCond] = parallel.internal.codistextern.denseMldivideSquare(localA, ...
                                                      descA, localB, descB, lbgrid(1), lbgrid(2), ...
                                                      distA.Orientation, transposeFirstMatrix, numOfCol, ...
                                                      isrealA, isrealB);
