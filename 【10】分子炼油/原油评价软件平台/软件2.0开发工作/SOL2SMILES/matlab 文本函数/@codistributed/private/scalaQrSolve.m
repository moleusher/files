...
if ~distributedB
    B = [B; zeros(numOutputRows - size(B, 1), size(B, 2), 'like', B)];
    ...
    localB = [localB; zeros(newDistB.hLocalSize() - [size(localB, 1) 0], ...
                            'like', localB)];
...
localA = parallel.internal.codistextern.denseMldivideRectangle(localA, descA, ...
                                                  localB, descB, lbgrid(1), ...
                                                  lbgrid(2), distA.Orientation,...
                                                  isrealA, isrealB);
