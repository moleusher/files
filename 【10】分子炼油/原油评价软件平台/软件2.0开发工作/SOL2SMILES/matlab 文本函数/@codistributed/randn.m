...
%   
%   D = RANDN(...,'like',P) for a codistributed argument P returns a 
%   codistributed array of normally distributed pseudorandom numbers with the 
...
%       D4 = randn([N, N*2], 'like', D3); % underlying class 'single'
